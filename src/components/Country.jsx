...
export const Country = () => {
    ...
    return (
        <div className='container mx-auto p-2 my-5'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full bg-white border border-gray-200 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <img className="object-cover w-full max-h-96 rounded-t-lg md:rounded-none md:rounded-s-lg p-2" src={pais.flags.svg} alt={`Bandera de ${pais.name}`} />
