...
export function Flags() {
    ...
    return (
        <div className='container p-2 mx-auto my-5'>
            <div className='grid grid-cols-1 sm:grid-cols-2 mt-5 mb-10 gap-2'>
                <div className="relative">
                    ...
                    <input
                        type="text"
                        id="default-search"
                        className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg dark:shadow-md dark:shadow-gray-900 placeholder-gray-500 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-100 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {filteredDatos.length > 0 ? (
                    ...
                    <p className='text-center my-10 dark:text-gray-400 col-span-4'>No matches found</p>
                )}
            </div>
        </div>
    );
